...
from core.llm_api.llama_llm import HUGGINGFACE_MODELS, HuggingFaceModel
...
class ModelAPI:
    ...
    _llama_chat: HuggingFaceModel = attrs.field(init=False)
    ...
    def __attrs_post_init__(self):
        ...
        self._llama_chat = HuggingFaceModel(
            num_threads=self.anthropic_num_threads,
